...
from src_helix.api_utils import get_api_token, VERKADA_API_BASE_URL, fetch_lpr_enabled_cameras, fetch_lpr_images_for_camera, format_timestamp, configure_logging, filter_lpr_by_non_lpoi, fetch_all_lpoi
...
def main():
    ...
    Filters the detections to include only those *not* in the LPOI list.
    Prints the non-LPOI detections in a formatted table.
    ...
    try:
        ...
        # --- Step 4: Filter detections by NON-LPOI ---
        ...
        if non_lpoi_detections:
            ...
            # Include the time range in the header
